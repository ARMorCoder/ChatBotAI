...
#Create Chat window
ChatLog = Text(base, bd=0, bg="#8ecfd1", height="8", width="50", font="Arial",)
...
SendButton = Button(base, font=("Lucida Console",12,'bold'), text="Send", width="10", height=5,
                    bd=0, bg="#2c5e9e", activebackground="#3c9d9b",fg='#ffffff',
                    command= send )

#Create the box to enter message
EntryBox = Text(base, bd=0, bg="#47d69f",width="29", height="5", font="Arial")
...
SendButton.place(x=5, y=400, height=90)
